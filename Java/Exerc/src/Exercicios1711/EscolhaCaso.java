...
public class EscolhaCaso {
	public static void main (String[] args) {
		...
		int numero=0;
			...
			System.out.println("Se o número de maças for menor igual a 11, digite 1. Se for maior igual a 12, digite 2: ");
			numero= read.nextInt();
			
			switch (numero) {
				case 1: {
					total=(quantidadeMaca*0.30);
					System.out.println("A quantidade de maças compradas foram "+quantidadeMaca+" e o total da compra foi de R$ "+total+"!");
					break;
				}
				case 2:{
