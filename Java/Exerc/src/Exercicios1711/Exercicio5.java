...
public class Exercicio5 {
	public static void main(String[] args) {
		...
		System.out.println("Programa que retorna a figura geoétrica de acordo com a quantidade de dados informada!");
		...
		if(numeroLado<3) {
			...
			System.out.println("A figura é um TRIÂNGULO e sua área é igual a "+ area+"!");
		}
		else if(numeroLado==4) {
			area=(ladoComprimento*ladoComprimento);
			System.out.println("A figura é um QUADRADO e sua área é igual a "+ area+"!");
		}
		else if (numeroLado==5) {
